...
import '../viewmodel/my_hives_bloc.dart';
import '../viewmodel/my_hives_event.dart';
import '../viewmodel/my_hives_state.dart';
import '../widgets/hive_filter_sheet.dart';
import '../widgets/hive_list_tile.dart';
...
class MyHivesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => MyHivesBloc(hiveRepository: sl<HiveRepository>())..add(const MyHivesRequested()),
