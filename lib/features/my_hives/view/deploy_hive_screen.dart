...
import '../viewmodel/deploy_hive_cubit.dart';
...
/// Pushed via Navigator.pushNamed(context, AppRoutes.deployHive).
...
class DeployHiveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => DeployHiveCubit(hiveRepository: sl<HiveRepository>()),
