...
import '../../feed/widgets/insight_feed_card.dart';
import '../viewmodel/overview_bloc.dart';
import '../viewmodel/overview_event.dart';
import '../viewmodel/overview_state.dart';
import '../widgets/hive_fleet_card.dart';
import '../widgets/stat_card.dart';
import '../widgets/yield_sparkline.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => OverviewBloc(
        hiveRepository: sl<HiveRepository>(),
